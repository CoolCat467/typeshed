...
class EditorWindow:
    ...
    ctip: Calltip
    def __init__(
        self, flist: FileList | None = ..., filename: str | None = ..., key: str | None = ..., root: Misc | None = ...
    ) -> None: ...
    ...
    def move_at_edge_if_selection(self, edge_index: int) -> Callable[[Event[Any]], None]: ...
    ...
    def get_geometry(self) -> tuple[int, int, int, int]: ...  # It's really a list object but more clear
    ...
    def apply_bindings(self, keydefs: dict[str, list[str]] | None = ...) -> None: ...
    def fill_menus(
        self, menudefs: list[tuple[str, list[tuple[str, str] | None]]] | None = ..., keydefs: dict[str, list[str]] | None = ...
    ) -> None: ...
    def getvar(self, name: str) -> str | int | float | bool: ...
    def setvar(self, name: str, value: str | int | float | bool, vartype: Variable | None = ...) -> None: ...
    def get_var_obj(self, name: str, vartype: Variable | None = ...) -> str | int | float | bool: ...
    ...
    def set_indentation_params(self, is_py_src: bool, guess: bool = ...) -> None: ...
