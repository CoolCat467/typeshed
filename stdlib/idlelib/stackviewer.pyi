...
def StackBrowser(
    root: Misc, flist: PyShellFileList | None = ..., tb: TracebackType | None = ..., top: Toplevel | None = ...
) -> None: ...
...
class StackTreeItem(TreeItem):
    ...
    def get_stack(self, tb: TracebackType) -> list[tuple[FrameType, int]]: ...  # type: ignore[override]
...
class VariablesTreeItem(ObjectTreeItem):
    def GetText(self) -> str: ...  # type: ignore[override]
    def GetLabelText(self) -> None: ...  # type: ignore[override]
