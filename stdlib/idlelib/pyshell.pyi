...
class PyShellEditorWindow(EditorWindow):
    ...
    def ranges_to_linenumbers(self, ranges: tuple[Tcl_Obj, ...]) -> list[int]: ...
...
class ModifiedInterpreter(InteractiveInterpreter):
    ...
    def runcommand(self, code: str) -> bool: ...  # Actually returns int object but that is a hack because of int truthyness
